...
#     T_top3001 = np.load('../data_borehole_simulations/GRIP_simulations/GRIP_PA31_surfaceTem_10.npy')
    ...
    print('GRIP_res_%dsensor_5derr_linear'%(sn))
    ...
    print('GRIP_res_%dsensor_5derr_logarthmic'%(sn))
    ...
    if go_status=='okay':
        print('GRIP_res_%dsensor_5derr_go_avg'%(sn))
        no_of_cases=1000
    ...
    np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_sensor_depths_linear'%(sn),sensor_depths_linear)
    np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_accumulated_error_linear'%(sn),accumulated_error_linear)
    np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_sensor_depths_logarthmic'%(sn),sensor_depths_logarthmic)
    np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_accumulated_error_logarthmic'%(sn),accumulated_error_logarthmic)
    if go_status=='okay':
        np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_sensor_depths_go_avg'%(sn),sensor_depths_go_avg)
        np.save('../output/GRIP_varying_sensors_5_20/device_error_05mK/GRIP_res_%dsensor_5derr_accumulated_error_go_avg'%(sn),accumulated_error_go_avg)
