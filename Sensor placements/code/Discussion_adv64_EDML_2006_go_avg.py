...
if go_status=='okay':
    np.save('../output/Discussion/Advection_impact/EDML_adv64_sensor_depths2006_go_avg',sensor_depths_go_avg)
    np.save('../output/Discussion/Advection_impact/EDML_adv64_accumulated_error_2006_go_avg',accumulated_error_go_avg)
