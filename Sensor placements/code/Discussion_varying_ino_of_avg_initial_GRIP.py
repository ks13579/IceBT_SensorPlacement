...
for av in no_avg:
    ...
    print('GRIP_sensor_0derr_go_avges_%d'%(av))
    no_of_cases=av
    ...
    if status == 'okay':
        if no_of_cases == 1000:  # for min line
            ...
            np.save('../output/Discussion/Numerical_uncertainty/GRIP_Model_error/GRIP_%d_minLine_sensor_accumulated_error_go_1000'%(av),sensor_accumulated_error_go_1000)
            np.save('../output/Discussion/Numerical_uncertainty/GRIP_Model_error/GRIP_%d_minLine_sensors_go_1000'%(av),np.array(sensor_depths_go_1000))
        ...
        np.save('../output/Discussion/Numerical_uncertainty/GRIP_Model_error/GRIP_%d_sensor_depth_go_avges'%(av),sensor_depths_go_avg)
        np.save('../output/Discussion/Numerical_uncertainty/GRIP_Model_error/GRIP_%d_acc_error_go_avges'%(av),accumulated_error_go_avg)
        #np.save('../output/Discussion/Numerical_uncertainty/GRIP_Model_error/GRIP_%d_errors_go_avges'%(av),errors_go_avg)
