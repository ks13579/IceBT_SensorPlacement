...
T_end2006 = np.load('../data_borehole_simulations/EDML_simulations/EDML_Discussion_ws0EDML_PA2_6_simulation_1000_ic_corrected.npy')

# array containing surface temperature profiles
T_top2006 = np.load('../data_borehole_simulations/EDML_simulations/EDML_Discussion_ws0EDML_PA2_6_surfaceTem_1000_ic_corrected.npy')
...
if go_status=='okay':
    np.save('../output/Discussion/Advection_impact/EDML_0adv_sensor_depths2006_go_avg',sensor_depths_go_avg)
    np.save('../output/Discussion/Advection_impact/EDML_0adv_accumulated_error_2006_go_avg',accumulated_error_go_avg)
