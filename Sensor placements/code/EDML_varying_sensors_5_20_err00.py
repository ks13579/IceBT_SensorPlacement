...
#     T_top3001 = np.load('../data_borehole_simulations/EDML_simulations/EDML_PA31_surfaceTem_10.npy')
    ...
    np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_sensor_depths_linear'%(sn),sensor_depths_linear)
    np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_accumulated_error_linear'%(sn),accumulated_error_linear)
    np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_sensor_depths_logarthmic'%(sn),sensor_depths_logarthmic)
    np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_accumulated_error_logarthmic'%(sn),accumulated_error_logarthmic)
    if go_status=='okay':
        np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_sensor_depths_go_avg'%(sn),sensor_depths_go_avg)
        np.save('../output/EDML_varying_sensors_5_20/device_error_00mK/EDML_res_%dsensor_0derr_accumulated_error_go_avg'%(sn),accumulated_error_go_avg)
