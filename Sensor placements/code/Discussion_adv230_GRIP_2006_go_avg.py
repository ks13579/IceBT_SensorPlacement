...
if go_status=='okay':
    np.save('../output/Discussion/Advection_impact/GRIP_adv230_sensor_depths2006_go_avg',sensor_depths_go_avg)
    np.save('../output/Discussion/Advection_impact/GRIP_adv230_accumulated_error_2006_go_avg',accumulated_error_go_avg)
